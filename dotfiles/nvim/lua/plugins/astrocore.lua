		...
		mappings = {
			...
			n = {
				...
				["<Leader>zp"] = {
					...
					desc = "Find papers in Zotero storage and open in pdf viewer",
				},
				["<Leader>zc"] = {
					function()
						require("utils.snack_picker").zotero_papers({ copy_without_open = true })
					end,
					desc = "Find papers in Zotero storage and copy paper name to clipboard",
				},
				["<Leader>zn"] = {
					function()

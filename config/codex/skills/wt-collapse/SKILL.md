---
name: wt-collapse
description: "Merge work from the current worktree into a target branch, then remove the worktree and its companion branch. Use when a task is finished and ready to land."
---

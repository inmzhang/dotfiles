...
/* Entry point renamed from crc32_impl to crc32c_avx512_impl for use   */
/* with the dispatch wrapper in fast-crc32c-impl.md.                    */
/* All other code is verbatim from the corsix fast-crc32 generator.     */
/* Original: https://github.com/corsix/fast-crc32/                     */
...
CRC_EXPORT uint32_t crc32c_avx512_impl(uint32_t crc0, const char* buf, size_t len) {
  crc0 = ~crc0;
